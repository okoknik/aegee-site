  ...
  return (
    <main>
      <div className="flex md:flex-row max-sm:flex-col justify-center   max-sm:-z-50 ">
        <div className="flex flex-col justif-center w-1/2 mx-10 ml-24 tracking-wider align-center text-6xl p-5 max-sm:z-1">
